...
import type {ChangeIR, ChangedFile, FilePatch, SummarySource, SummaryStrategy} from './types.js';
 ...
 * @return {string} 文件摘要。
 */
function buildFileChangeSummary(file: ChangedFile, role: string, symbols: string[], dependencyChanges: string[]): string {
