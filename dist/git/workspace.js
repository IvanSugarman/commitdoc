 ...
 */
export async function executeGit(args) {
 ...
 */
async function getStagedNameStatus() {
 ...
 */
async function getWorkingTreeNameStatus() {
 ...
 */
async function getWorkingTreePatch() {
 ...
 */
async function getWorkspaceNameStatus() {
    try {
