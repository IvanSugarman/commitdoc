...
import { buildFileSummary, buildFilesOverview, buildGroupSummary, buildSemanticHints, isHighContextFile, isIgnoredFile, sortFilesByPriority } from './change-analysis/file-classifier.js';
...
export async function getChangesForSummary() {
    ...
    const cached = await readJsonCache('summary', cacheKey);
    if (cached) {
