import { allowsGitExecution, getBriefOption } from './commands.js';
/**
 ...
 * @return {string[]} 行列表。
 */
function buildCrDescriptionLines(brief) {
    return [
        '## Change Purpose',
        brief.changePurpose,
        '',
 ...
 */
export function getCommitPayload(renderedBrief) {
 ...
 */
export function isCommitFlowBrief(brief) {
 ...
 */
export function normalizeCrDescriptionBrief(brief, filesOverview, nameStatus, strategy) {
    return {
        ...brief,
 ...
 */
function pickImpactScope(filesOverview) {
 ...
 */
function buildReviewerFocus(strategy) {
 ...
 * @return {string} 测试说明。
 */
function buildTestingValidation(nameStatus) {
